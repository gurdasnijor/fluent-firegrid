...
| `packages/conformance` (server) | Portable behavior coverage for substrate capabilities                                            | Package-specific runtime assumptions                 |
...
2. add or update `packages/conformance` (server) coverage;

...
import { bindFluentDefinitions, celFor, object, objectClient, sendObjectClient, state } from "@firegrid/fluent-firegrid"
...
export default proof("fluent-firegrid-s2.object-index-wait")
  .describedAs(
  ...
  .spec(({ property, trialId }) =>
    property("fluent-firegrid-s2.object-index-wait-proof")

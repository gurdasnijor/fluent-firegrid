...
export default proof("tanstack-workflow-s2.runtime-approval")
  .describedAs(
  ...
  .spec(({ property, trialId }) =>
    property("tanstack-workflow-s2.runtime-approval-proof")
      .s2Lite({ persistence: "local-root" })
      .workload(({ s2Endpoint }) =>
        Effect.gen(function*() {
          if (s2Endpoint === undefined) {
            return yield* new VerificationError({
              message: "tanstack-workflow-s2 runtime approval proof requires s2Lite"
            })
          }

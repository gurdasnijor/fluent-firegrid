...
export class S2Config extends Context.Service<S2Config, S2ClientOptions>()("@firegrid/log/S2Client/S2Config") {}

export class S2Client extends Context.Service<S2Client, S2ClientApi>()("@firegrid/log/S2Client") {}

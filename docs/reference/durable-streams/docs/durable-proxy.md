...
- Use [Vercel AI SDK](vercel-ai-sdk.md) when you are integrating directly with Vercel AI SDK.
- Use [TanStack AI](tanstack-ai.md) when you want the TanStack AI transport adapter.

...
| B3 | B | Lifecycle authority: claim, durable cancel, timeouts + proofs | MS-C5 | B1 | in-progress | Claude (B lane) | #103 (SURFACE STOP) |
...
| D2 | D | Adapter contract + fixture-replay proof harness | MS-C6 | D1 | surface-approved | Claude (D lane) | #99 |

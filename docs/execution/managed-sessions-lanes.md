...
| A4 | A | Session history fold + thread-index projection + proofs | MS-C4 | A1, B1 | surface-approved | Claude (A lane) | #112 |
...
| C2 | C | Folded timer index; latency + single-claim + exactly-once proofs | MS-C3 | C1 | done | Claude (C lane) | #110 |

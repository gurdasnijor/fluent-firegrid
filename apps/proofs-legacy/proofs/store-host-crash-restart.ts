...
const workerPath = new URL("../fixtures/store-host-worker.ts", import.meta.url).pathname
...
export default proof("store.host-crash-restart")
  .describedAs(
  ...
  .spec(({ property, trialId }) => {
    ...
    return property("store.host-crash-restart-proof")

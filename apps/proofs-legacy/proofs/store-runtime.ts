...
export default proof("store.runtime-end-to-end")
  .describedAs(
  ...
  .spec(({ property, trialId }) =>
    property("store.runtime-end-to-end-proof")
      .s2Lite({ persistence: "local-root" })
      .workload(({ s2Endpoint }) =>
        Effect.gen(function*() {
          if (s2Endpoint === undefined) {
            return yield* new VerificationError({ message: "store runtime proof requires s2Lite" })
          }
